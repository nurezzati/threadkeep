    ...
    <div className="">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2">
          ...
          {/* ① URL */}
          <div className="flex-1 flex items-center border border-black px-3 h-14 sm:h-10 min-w-0">
            <input
              type="text"
              value={url}
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1 sm:w-36 sm:flex-none flex items-center border border-black px-3 h-8 sm:h-10">
              {category === "__new__" ? (
                <input
                  autoFocus
                  type="text"
            ...
            <button
              ...
              className="shrink-0 h-8 sm:h-10 border border-black px-5 text-[10px] tracking-[0.3em] uppercase font-semibold bg-black text-white hover:bg-white hover:text-black transition-colors disabled:opacity-40"
            >
